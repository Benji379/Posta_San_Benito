...
public class MdlUsuarios extends javax.swing.JPanel {
    ...
    ControladorUsuarios C;

    public MdlUsuarios() {
        initComponents();
        C = new ControladorUsuarios(this);
        C.init();
    }
    ...
    private void initComponents() {
        ...
        textFieldSuggestion7 = new Componentes.TextFieldSuggestion();
        ...
        textFieldSuggestion7.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        textFieldSuggestion7.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                textFieldSuggestion7KeyTyped(evt);
            }
        });
        ...
        pPasswordLayout.setVerticalGroup(
            ...
            .addGroup(pPasswordLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(textFieldSuggestion7, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(15, 15, 15))
        );
    ...
    private void textFieldSuggestion7KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textFieldSuggestion7KeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_textFieldSuggestion7KeyTyped
    ...
    public Componentes.Button button1;
    ...
    public Componentes.TextFieldSuggestion textFieldSuggestion7;
